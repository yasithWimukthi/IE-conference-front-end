...
class CometChatIncomingCall extends React.PureComponent {
    ...
    render() {
        ...
        if (this.state.incomingCall) {
            let callType = (
                <React.Fragment>
                    <i css={callIconStyle(audioCallIcon, this.context)}
            ...
            if (this.state.incomingCall.type === CometChat.CALL_TYPE.VIDEO) {
                callType = (
                    <React.Fragment>
                        <i css={callIconStyle(videoCallIcon, this.context)}
                ...
                <div css={incomingCallWrapperStyle(this.props, keyframes)} className="callalert__wrapper">
                    <div css={callContainerStyle()} className="callalert__container">
                        ...
                        <div css={headerButtonStyle()} className="callalert__buttons" ref={this.callButtonRef}>
                            <button type="button" css={ButtonStyle(this.props, 0)} className="button button__decline"
                            ...
                            <button type="button" css={ButtonStyle(this.props, 1)} className="button button__accept"
        ...
        if (this.state.callInProgress) {
            callScreen = <CometChatCallScreen loggedInUser={this.loggedInUser} call={this.state.callInProgress}
                                              lang={this.props.lang} actionGenerated={this.actionHandler}/>;
        }
