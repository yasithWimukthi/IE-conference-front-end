                ...
                <div css={modalWrapperStyle(this.context)} className="modal__addmembers">
                    ...
                    <div css={modalBodyStyle()} className="modal__body">
                        <div css={modalCaptionStyle(Translator.getDirection(this.context.language))}
                             className="modal__title">{Translator.translate("USERS", this.context.language)}</div>
                        ...
                        {messageContainer}
                        <div css={modalListStyle(this.context)} onScroll={this.handleScroll}
                             className="modal__content">{users}</div>
                        {addGroupMemberBtn}
                    </div>
                </div>
            </React.Fragment>
