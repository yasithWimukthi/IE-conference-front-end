    ...
    render() {
        ...
        if (groupTypeKeys.length) {
            ...
            if (groupTypeKeys.length > 1) {
                groupTypeSelect = (
                    <tr>
                        <td>
                            <select css={inputStyle(this.props)} className="grouptype" onChange={this.typeChangeHandler}
                                    value={this.state.type} tabIndex="2">
                                <option
                                    value="">{Translator.translate("SELECT_GROUP_TYPE", this.context.language)}</option>
        ...
        if (this.state.passwordInput) {
            password = (
                <tr>
                    <td>
                        <input autoComplete="off" css={inputStyle(this.context)}
                               placeholder={Translator.translate("ENTER_GROUP_PASSWORD", this.context.language)}
                               type="password" tabIndex="3" onChange={this.passwordChangeHandler}
        ...
        return (
            <React.Fragment>
                ...
                <div css={modalWrapperStyle(this.context)} className="modal__creategroup">
                    <span css={modalCloseStyle(closeIcon, this.context)} className="modal__close"
                    ...
                    <div css={modalBodyStyle()} className="modal__body">
                        <table css={modalTableStyle(this.props)}>
                            <caption css={tableCaptionStyle()}
                                     className="modal__title"> {Translator.translate("CREATE_GROUP", this.context.language)} </caption>
                            ...
                            <tr>
                                <td>
                                    <input autoComplete="off" css={inputStyle(this.props)} className="search__input"
                                           placeholder={Translator.translate("ENTER_GROUP_NAME", this.context.language)}
                                           type="text" tabIndex="1" onChange={this.nameChangeHandler}
