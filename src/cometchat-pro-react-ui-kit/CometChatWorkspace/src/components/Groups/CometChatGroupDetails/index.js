    ...
    render() {
        ...
        let viewMembersBtn = (
            <div css={contentItemStyle()} className="content__item">
                <div css={itemLinkStyle(this.context, 0)} className="item__link"
        ...
        if (this.state.addMember) {
            addMembers = <CometChatAddGroupMemberList close={() => this.clickHandler("addmember", false)}
                                                      actionGenerated={this.membersActionHandler}/>;
        }

        let bannedMembers = null;
        if (this.state.banMember) {
            bannedMembers = <CometChatBanGroupMemberList loggedinuser={this.state.loggedInUser}
        ...
        if (this.state.showDeleteConfirmDialog) {
            showDeleteConfirmDialog = (
                <CometChatConfirmDialog {...this.props} onClick={this.onDeleteConfirm}
        ...
        if (this.state.showLeaveGroupConfirmDialog) {
            showLeaveGroupConfirmDialog = (
                <CometChatConfirmDialog {...this.props} onClick={this.onLeaveConfirm}
        ...
        if (this.state.transferOwnership) {
            transferOwnership =
                <CometChatTransferOwnershipMemberList roles={this.roles} loggedinuser={this.state.loggedInUser}
                                                      actionGenerated={this.membersActionHandler}
        ...
        return (
            <div css={detailStyle(this.context)} className="detailpane">
                <div css={headerStyle(this.context)} className="detailpane__header">
                    <div css={headerCloseStyle(navigateIcon, this.context)} className="header__close"
                         onClick={this.closeGroupDetail}></div>
